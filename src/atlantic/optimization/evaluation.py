...
from atlantic.core.enums import TaskType, OptimizationLevel
        ...
        for param_name, value_range in config.items():
            ...
            if param_name == "learning_rate":
                ...
                params[param_name] = trial.suggest_int(
                    full_name, value_range[0], value_range[1]
                )
    ...
    def _objective(self, trial: "optuna.Trial") -> float:
        ...
        with warnings.catch_warnings():
            ...
            for model_name, model in models.items():
                ...
                if (self._dim_config.model_complexity == "low" and 
                    "et_" in model_name):
                    continue
                ...
                metrics_df = MetricRegistry.compute_all(
                    y_test, pred, task_type, self.n_classes
                )
